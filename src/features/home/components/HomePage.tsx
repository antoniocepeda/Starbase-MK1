...
import { RotatingTagline } from '../../tagline/components/RotatingTagline';
import { PromotionalModal } from '../../promotional/components/PromotionalModal';
import { PROMOTIONAL_CONTENT } from '../../promotional/constants';

export function HomePage({
  onShowOnlineCourses,
  onShowInPersonClasses,
  onShowRobotKits
}: {
  onShowOnlineCourses: () => void;
  onShowInPersonClasses: () => void;
  onShowRobotKits: () => void;
}) {
